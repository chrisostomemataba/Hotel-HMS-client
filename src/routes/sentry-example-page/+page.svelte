...
<div>
  <main>
    ...
    <p class="description">
      Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://kemosabe.sentry.io/issues/?project=4509691274264576">Issues Page</a>. 
